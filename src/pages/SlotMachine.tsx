    ...
    <>
        ...
        <div className="contents">
          ...
          <div className="money">
            ...
            <span className="animate">
              <span className={`num ${isAnimating ? "please" : ""}`}>
                012345678901234
              </span>
            </span>
      ...
      <div className="buttongroup glass ">
        <div className="button-row">
          <button
            className="circle glass themer fa-regular fa-square"
            onClick={() => {
              setTheme("greentheme");
            }}
          >
          ...
          <button
            className="triangle glass themer fa-regular fa-circle"
            onClick={() => {
              setTheme("bluetheme");
            }}
          ></button>
          <button
            className="square glass themer fa-solid fa-sharp fa-play fa-rotate-270"
            onClick={() => {
              setTheme("pinktheme");
            }}
          ></button>
        </div>
        <button className="redo glass fa-solid fa-redo" onClick={handleClick}>
          {" "}
        </button>
      </div>
    </>
